...
public class ClienteDaoJDBC {
    ...
    //Este metodo recibe por parametro un objeto de tipo cliente con el constructor que solo recibe el id;
    ...
    public int insertar(Cliente cliente) {
        ...
        try {
            ...
            //Este metodo devuelve un entero con la cantidad de registros afectados
